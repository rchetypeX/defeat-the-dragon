...
exports.getAccessibleTextColor = exports.getContrastColor = exports.colors = void 0;
...
const getAccessibleTextColor = (backgroundColor, highContrast = false) => {
    if (highContrast) {
        return exports.colors.highContrast.text;
    }
    return (0, exports.getContrastColor)(backgroundColor);
};
